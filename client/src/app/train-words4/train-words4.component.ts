...
@Component({
  selector: 'app-train-words4',
  templateUrl: './train-words4.component.html',
  styleUrls: ['./train-words4.component.css']
})
export class TrainWords4Component implements OnInit {
