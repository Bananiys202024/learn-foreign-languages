...
@Component({
  selector: 'app-train-words3',
  templateUrl: './train-words3.component.html',
  styleUrls: ['./train-words3.component.css']
})
export class TrainWords3Component implements OnInit {
